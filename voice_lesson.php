	...
	echo "<table border='1' align='center' rules=rows frame=box bgcolor='white' width='700px'>";
		...
		echo "<tr bgcolor='white' CLASS='darkrow'>";
			echo "<td colspan='3' align='center'>";
				echo "Upload New Sound Lesson<br/>";
		...
		echo "<tr bgcolor='white' CLASS='darkrow'>";
			echo "<td align='center' colspan='3'>";
				echo "<font color='red' >Ps. Before upload, make sure your sound filename is <b>Lesson_x.mp3</b><br/>sample : <b>Lesson_99.mp3</b></font>";
			echo "</td>";
		echo "</tr>";
		...
		if ($handle = opendir('voice/lessons/')) {
